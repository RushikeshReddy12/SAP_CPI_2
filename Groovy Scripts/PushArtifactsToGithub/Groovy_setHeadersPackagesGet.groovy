...
def Message processData(Message message) {
    ...
    def packageId = prop.get('PACKAGE_ID').toString()
    ...
    def httpPackagesUrl = "https://api.github.com/repos/"+gitOwner+"/"+gitRepo+"/contents/IntegrationPackages/Zip/"+packageId+".zip"
    message.setProperty("httpPackagesUrl", httpPackagesUrl)
